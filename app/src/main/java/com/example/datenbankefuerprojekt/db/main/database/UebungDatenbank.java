...
public abstract class UebungDatenbank extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            uebungDao.insert(new Uebung("Title 1", "Description 1", 1,1));
            uebungDao.insert(new Uebung("Title 2", "Description 2", 1,1));
            uebungDao.insert(new Uebung("Title 3", "Description 3", 1,1));
            return null;
        }
    }
}
